( function( $ ) {
	...
	var wdtShopProducts = function($scope, $){
		...
		if($scope.hasClass('elementor-element-edit-mode')) {
			...
			var customCSS = jQuery('body', parent.document).find('style[id="a-for-apple-woo-non-archive-inline-css"]').text();
			jQuery('body', parent.document).find('style[id="a-for-apple-woo-non-archive-inline-css"]').remove();
			...
			var customJS = jQuery('body', parent.document).find('script[id="a-for-apple-woo-non-archive-js-after"]').text();
			jQuery('body', parent.document).find('script[id="a-for-apple-woo-non-archive-js-after"]').remove();
